...
namespace GraphShape
{
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        /// </exception>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="tag"/> is <see langword="null"/>.</exception>
        void HideVertices([NotNull, ItemNotNull] IEnumerable<TVertex> vertices,  string tag);
        ...
        /// <exception cref="T:System.ArgumentNullException"><paramref name="tag"/> is <see langword="null"/>.</exception>
        void HideVerticesIf([NotNull, InstantHandle] Predicate<TVertex> predicate,  string tag);
        ...
        /// </exception>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="tag"/> is <see langword="null"/>.</exception>
        void HideEdges([NotNull, ItemNotNull] IEnumerable<TEdge> edges,  string tag);
        ...
        /// <exception cref="T:System.ArgumentNullException"><paramref name="predicate"/> is <see langword="null"/>.</exception>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="tag"/> is <see langword="null"/>.</exception>
        void HideEdgesIf([NotNull, InstantHandle] Predicate<TEdge> predicate,  string tag);

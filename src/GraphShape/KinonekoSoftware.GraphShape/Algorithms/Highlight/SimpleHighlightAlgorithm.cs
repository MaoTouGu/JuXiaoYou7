...
namespace GraphShape.Algorithms.Highlight
{
        ...
        where TGraph : class, IBidirectionalGraph<TVertex, TEdge>
    {
        ...
        public override bool OnVertexHighlighting(TVertex vertex)
        {
            ...
            {
                Controller.SemiHighlightEdge(edge, SemiHighlightInfos.InEdge);
                ...
                Controller.SemiHighlightVertex(edge.Source, SemiHighlightInfos.Source);
            }

            // Semi-highlight the out-edges
            foreach (var edge in Controller.Graph.OutEdges(vertex))
            {
                Controller.SemiHighlightEdge(edge, SemiHighlightInfos.OutEdge);
                ...
                Controller.SemiHighlightVertex(edge.Target, SemiHighlightInfos.Target);
            }

            Controller.HighlightVertex(vertex, HighlightInfos.None);
            return true;
        }

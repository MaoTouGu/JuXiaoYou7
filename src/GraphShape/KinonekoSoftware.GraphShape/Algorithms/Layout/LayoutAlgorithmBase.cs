...
namespace GraphShape.Algorithms.Layout
{
    ...
    {
        /// <summary>
        /// <see cref="VisitedGraph"/> 属性表示当前布局的图。
        /// </summary>
        ...
        /// <exception cref="T:System.ArgumentNullException"><paramref name="visitedGraph"/> is <see langword="null"/>.</exception>
        protected LayoutAlgorithmBase( TGraph visitedGraph, [CanBeNull] IDictionary<TVertex, Point> verticesPositions)
        {
        ...
        internal virtual void RaiseIterationEnded( ILayoutIterationEventArgs<TVertex> args)
        {
        ...
        where TGraph : IVertexAndEdgeListGraph<TVertex, TEdge>
    {
        ...
        {
            if (VerticesInfos.TryGetValue(vertex, out var info))
                return info;
            return null;
        }
        ...
        {
            if (EdgesInfos.TryGetValue(edge, out var info))
                return info;
            return null;
        }

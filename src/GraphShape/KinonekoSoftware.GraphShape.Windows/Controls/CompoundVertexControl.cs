...
namespace GraphShape.Controls
{
    ...
    public class CompoundVertexControl : VertexControl, ICompoundVertexControl
    {
        ...
        private static void OnVertexMove( CompoundVertexControl compoundVertexControl,  PositionChangedEventArgs args)
        {
            ...
            else
            {
                ...
                if (compoundVertexControl.Vertices.Contains(childVertexControl))
                {
                    ...
                    foreach (var control in compoundVertexControl.Vertices)
                    {
                        ...
                        var translatedChildCenterPos = control.TranslatePoint(childCenterPos, control.RootCanvas);
        ...
        public Thickness VertexBorderThickness
        {
            get
            {
                ...
                var innerCanvasPosition = InnerCanvas.TranslatePoint(default(System.Windows.Point), this);

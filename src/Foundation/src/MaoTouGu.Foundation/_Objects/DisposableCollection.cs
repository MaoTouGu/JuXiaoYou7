...
{
    public class DisposableCollection : ICollection<IDisposable>, ICancelable, IDisposableCollector
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisposableCollection"/> class with no disposables contained by it initially.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisposableCollection"/> class with the specified number of disposables.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DisposableCollection"/> class from a group of disposables.
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of disposables contained in the <see cref="DisposableCollection"/>.
        /// </summary>
        public int Count => Volatile.Read(ref _count);
    
        /// <summary>
        /// Adds a disposable to the <see cref="DisposableCollection"/> or disposes the disposable if the <see cref="DisposableCollection"/> is disposed.
        /// </summary>
        ...
        /// <summary>
        /// Removes and disposes the first occurrence of a disposable from the <see cref="DisposableCollection"/>.
        /// </summary>
        ...
        /// <summary>
        /// Removes and disposes all disposables from the <see cref="DisposableCollection"/>, but does not dispose the <see cref="DisposableCollection"/>.
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        /// Determines whether the <see cref="DisposableCollection"/> contains a specific disposable.
        /// </summary>
        ...
        /// <summary>
        /// Copies the disposables contained in the <see cref="DisposableCollection"/> to an array, starting at a particular array index.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the <see cref="DisposableCollection"/>.
        /// </summary>

...
//            创建时间：2026年04月10日 21:43
//            版权所有：MaoTouGu Studio & Luoyisi
// 
// ----------------------------------------------------------
// Source - https://stackoverflow.com/a/26676294
// Posted by VoteCoffee, modified by community. See post 'Timeline' for change history
...
namespace MaoTouGu.Foundation.Collections
{
    ...
    public partial class ViewTable3<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, INotifyCollectionChanged, INotifyPropertyChanged, ICollection, IDictionary
    {
        private readonly Dictionary<TKey, TValue> _dictionary;

        /// <summary>
        /// Initializes an instance of the ViewTable class.
        /// </summary>
        public ViewTable3()
        {

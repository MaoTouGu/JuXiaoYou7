// ----------------------------------------------------------
//            文件：SettingGTFilter.cs
//            作者：Luoyisi<acorisbk@qq.com>
//            创建时间：2026年04月09日 20:56
...
namespace MaoTouGu.Studio.Database.References
{
    ...
    /// 设定项，≥范围筛选器。
    /// </summary>
    public class SettingGTFilter : CustomFilter
    {
        private string _key;
        private int    _value;
        ...
        public override bool Equals(CustomFilter other)
        {
            ...
            if (other is not SettingGTFilter b)
            {
                return false;
            }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != GetType())
                return false;
            return Equals((SettingGTFilter)obj);
        }

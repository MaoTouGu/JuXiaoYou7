...
namespace MaoTouGu.Studio.Database.Utils
{
    public static class ID
    {
        ...
        public static string Get() => Guid.NewGuid().ToString("N");

        public static string GetShortID() => ShortGuid.NewGuid();

        public static string From(string id) => ShortGuid.Parse(id).Guid.ToString("N");
    }
}
...
namespace MaoTouGu.Studio.Database
{
    ...
    /// </summary>
    public partial class BsonMapperBase : IBsonMapper
    {
        #region Properties
        ...
        internal Action<Type, MemberInfo, MemberMapper> _ResolveMember;
        internal Func<Type, string>                     _ResolveCollectionName;
        internal Func<string, string>                   _ResolveFieldName;


        #endregion

        public BsonMapperBase(Func<Type, object> customTypeInstantiator = null, ITypeNameBinder typeNameBinder = null)
        {
            this.SerializeNullValues = false;
            this.TrimWhitespace      = true;
            this.EmptyStringToNull   = true;
            this.EnumAsInteger       = false;
            this._ResolveFieldName   = (s) => s;
            this._ResolveMember = (t, mi, mm) =>
                                  {
                                  };
            this._ResolveCollectionName = (t) => Reflection.IsEnumerable(t) ? Reflection.GetListItemType(t).Name : t.Name;
            ...
            _entities = new ConcurrentDictionary<Type, EntityMapper>();
            TypeMapper    = new ReadOnlyDictionary<Type, EntityMapper>(_entities);
        }
        ...
        /// </summary>
        public BsonMapperBase UseCamelCase()
        {
            _ResolveFieldName = (s) => char.ToLower(s[0]) + s.Substring(1);
        ...
        /// </summary>
        public BsonMapperBase UseLowerCaseDelimiter(char delimiter = '_')
        {
            _ResolveFieldName = (s) => _lowerCaseDelimiter.Replace(s, delimiter + "$2").ToLower();
        ...
        /// </summary>
        internal static void RegisterDbRef(IBsonMapper mapper, MemberMapper member, ITypeNameBinder typeNameBinder, string collection)
        {
            member.IsDbRef = true;
        ...
        /// </summary>
        private static void RegisterDbRefItem(IBsonMapper mapper, MemberMapper member, ITypeNameBinder typeNameBinder, string collection)
        {
            // get entity
        ...
        /// </summary>
        private static void RegisterDbRefList(IBsonMapper mapper, MemberMapper member, ITypeNameBinder typeNameBinder, string collection)
        {
        ...
        {
            get => _ResolveFieldName; 
            set => _ResolveFieldName = value;
        }
        ...
        public ReadOnlyDictionary<Type, EntityMapper> TypeMapper { get; }
    }
}
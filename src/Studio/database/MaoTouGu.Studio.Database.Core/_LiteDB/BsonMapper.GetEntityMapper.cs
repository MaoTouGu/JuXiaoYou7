...
{
    public partial class BsonMapperBase
    {
        /// <summary>
        /// Mapping cache between Class/BsonDocument
        /// </summary>
        private readonly ConcurrentDictionary<Type, EntityMapper> _entities;
        ...
        protected void BuildEntityMapper(EntityMapper mapper)
        {
            ...
            foreach (var memberInfo in members)
            {
                ...
                {
                    BsonMapperBase.RegisterDbRef(this, member, _typeNameBinder,
                                                 dbRef.Collection ?? this._ResolveCollectionName((memberInfo as PropertyInfo).PropertyType));
                }

...
{
    public class GuideAdornerCanvas : Adorner
    {
        ...
        public GuideAdornerCanvas(UIElement alwaysContentPresenter, GuideObject dataContext, FrameworkElement target) : base(alwaysContentPresenter)
        {
            _target      = target;
            ...
            _guideContext = new GuideIndicator();

            _collection.Add(_guideContext);
            _collection.Add(_dummyBorder);

            //
            //
            _guideContext.DataContext = dataContext;
            
            //
            //
            AddLogicalChild(_guideContext);
        }
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            _guideContext.Measure(constraint);
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            {
                case Placement.Left:
                    x = _targetRect.X - _guideContext.ActualWidth - 3;
                    y = _targetRect.Y;
                    break;
                ...
                case Placement.Top:
                    x = _targetRect.X;
                    y = _targetRect.Y - _guideContext.ActualHeight - 3;
                    break;
            ...
            //
            // 横坐标不应该超出边界
            x = Math.Clamp(x, 0, AdornedElement.RenderSize.Width - _guideContext.ActualWidth);
            y = Math.Clamp(y, 0, AdornedElement.RenderSize.Height - _guideContext.ActualHeight);
            
            //
            // 布局。
            _guideContext.Arrange(
                                  new Rect(
                                           x, 
                                           y, 
                                           _guideContext.ActualWidth,
                                           _guideContext.ActualHeight));
